    ...
    <div className="relative z-20">
      {
        ...
        <div className="flex flex-col items-center justify-center  bg-white p-6 rounded-2xl shadow-xl min-w-80 md:w-96">
          ...
          <div className="w-fit h-fit bg-slate-100  rounded-full p-1">
            <img src={`https://ui-avatars.com/api/?name=${userInfo?.name}`} className="w-24 h-24 object-cover rounded-full select-none"/>
          </div>
          ...
          <p className="text-gray-400 text-xs">{userInfo.createdAt && new Date(userInfo?.createdAt).toLocaleString('en-US', {year:'numeric', month: 'long', day: 'numeric'})}</p>
