...
function UserBadgeItem({ handleRemove, user, groupAdminId, isCreatingGroupChat=false}) {
  ...
  return (
    <div
      ...
      onClick={(isCreatingGroupChat || (!isGroupAdmin && isLoggedInAdmin)) ? handleRemove : undefined}
    >
